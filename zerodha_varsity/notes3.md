...
Finally, Sales+Services+Other Revenues=Total operating revenue
...
PBT= Total revenue - Total operating expnenses - Extraordinary expenses.
...
In a typical balance sheet, Assets=Liabilities, because everything that is owned by company was purchased on a loan or the owner's capital.
...
Share capital = Face value of the stock(FV) * Number of shares in the open market.

Thus, Number of shares= Share capital/FV
...
##### Fixed assets
These are items (both tangible and intangible) that the company owns which cannot be liquidated easily